...
const INITIAL_TASKS: Task[] = [
    { id: '1', title: '경쟁사 분석 보고서 작성', description: '주요 경쟁사 3곳의 기능 및 디자인 분석', status: 'todo', priority: 'high', createdAt: Date.now(), updatedAt: Date.now(), tags: ['분석', '기획'], isFavorite: true },
    { id: '2', title: '디자인 시스템 가이드 초안', description: '메인 컬러 팔레트 및 폰트 계층 정의', status: 'todo', priority: 'medium', createdAt: Date.now() - 100000, updatedAt: Date.now() - 100000, tags: ['디자인'] },
    ...
    { id: '4', title: '로그인/회원가입 페이지 구현', description: 'JWT 토큰 기반 인증 로직 연동', status: 'in-progress', priority: 'high', createdAt: Date.now() - 200000, updatedAt: Date.now() - 200000, tags: ['개발', '보안'] },
    ...
    { id: '6', title: '사용자 피드백 수집', description: '베타 테스터 설문조사 결과 정리', status: 'in-progress', priority: 'medium', createdAt: Date.now() - 300000, updatedAt: Date.now() - 300000, tags: ['피드백'] },
    ...
    { id: '9', title: 'CI/CD 파이프라인 구축', description: 'GitHub Actions를 이용한 자동 배포 설정', status: 'todo', priority: 'high', createdAt: Date.now() - 120000, updatedAt: Date.now() - 120000, isFavorite: true },
